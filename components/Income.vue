...
<template>
  <section class="min-h-screen p-10 flex flex-col justify-center items-center bg-gray-50">
    <h2 class="text-3xl font-semibold mb-4 mx-auto max-w-4xl">Einkommen nach Berufsfeld</h2>


    <div id="map" class="w-full mx-auto max-w-4xl">
    ...
    <sections class="mx-auto max-w-4xl">
      <p>
